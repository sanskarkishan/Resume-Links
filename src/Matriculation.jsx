...
const docs = [
  ...
  { src: passingCert, label: "X Passing Certificate" },
  { src: marksheet, label: "X Marksheet" },
];
...
export const Matriculation = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-slate-800 px-2 sm:px-0 pb-32">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-wide text-indigo-400 text-center drop-shadow-lg mb-8 mt-8">Matriculation</h1>
